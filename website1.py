import os
import streamlit as st      #UserInterFace
import pickle
import google.generativeai as genai  # Gemini API
from langchain.text_splitter import RecursiveCharacterTextSplitter
from langchain.document_loaders import UnstructuredURLLoader
from langchain.vectorstores import FAISS    #Vector
...
st.set_page_config(
    page_title="Website and PDF Research Bot 📚",
    page_icon="🔍",
    layout="wide",
)
...
# Title
st.markdown('<h1 class="main-title">🚀 Website and PDF Research Tool 📊</h1>', unsafe_allow_html=True)
